    ...
    <header className="w-full font-poppins">
      ...
      <div className="bg-[radial-gradient(ellipse_farthest-corner_at_right_bottom,#FEDB37_0%,#FDB931_8%,#9f7928_30%,#8A6E2F_40%,transparent_80%),radial-gradient(ellipse_farthest-corner_at_left_top,#FFFFFF_0%,#FFFFAC_8%,#D1B464_25%,#5d4a1f_62.5%,#5d4a1f_100%)] text-white py-2 px-6 md:px-20 flex justify-between items-center text-xs md:text-sm border-b border-white/5">
        ...
        <div className="flex items-center gap-6">
          <a href="tel:+919717580410" className="flex items-center gap-2 font-medium">
        ...
        <div className="flex items-center gap-2">
          <a href="mailto:business@lingosetu.com" className="flex items-center gap-2 font-medium">
      ...
      {/* NAVBAR */}
      <nav className="bg-white h-[80px] px-6 md:px-20 flex items-center justify-between shadow-sm sticky top-0 z-50">
        ...
        <div className="hidden lg:flex items-center gap-10 text-[15px] font-medium text-gray-700">
          {menuItems.map((item, index) => (
            <button
              ...
              className="hover:text-[#9f7928] transition-colors"
            >
              {item.name}
            </button>
          ))}
