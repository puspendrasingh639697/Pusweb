  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-24 lg:pt-32 pb-16 px-6 md:px-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Halki overlay taaki text clear dikhe */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white space-y-8">
          ...
          >
            <p>
              ...
              <br/>
              {/* FIXED HEIGHT BOX: Isse page hilega nahi typing ke waqt */}
        ...
        >
          ...
          <form className="p-8 space-y-4 bg-white rounded-b-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" placeholder="Full Name*" className="w-full border-b border-blue-800 py-2 outline-none focus:border-[#FDB931] text-sm text-black" />
              <input type="email" placeholder="Business Email Address*" className="w-full border-b border-blue-800 py-2 outline-none focus:border-[#FDB931] text-sm text-black" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input type="text" placeholder="Organization / Institution*" className="w-full border-b border-blue-900 py-2 outline-none focus:border-[#FDB931] text-sm text-black" />
            </div>

            <textarea placeholder="Message*" rows="3" className="w-full border-b border-blue-900 py-2 outline-none focus:border-[#FDB931] text-sm text-black resize-none" />
