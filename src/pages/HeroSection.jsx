...
Enhanced with AI Technology</p>
  ...
  {[
    ...
    >
      ...
      <div className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full border border-white/30 group-hover:bg-white transition-colors">
        <CheckCircle2 size={18} className="text-white group-hover:text-black" />
      </div>

      {/* Text - Leading Tight height kam rakhega */}
